...
public class TodoImplDAO implements TodoDAO {
    ...
    public void insertTodo(Todo todo) throws SQLException {
        ...
        try (Connection connection = dbConnector.getConnection(); 
            ...
            //preparedStatement.setDate(4, todo.getSQLDate(todo.getTargetDate()));
            preparedStatement.setBoolean(5, todo.getStatus());
            System.out.println(preparedStatement);
            preparedStatement.executeUpdate();
        } catch (SQLException exception) {
           // Connection.printSQLException(exception);
        }
    }
    ...
    public boolean deleteTodo(int id) throws SQLException {
        boolean rowDeleted;
        try (Connection connection = dbConnector.getConnection(); PreparedStatement statement = connection.prepareStatement(DELETE_TODO_BY_ID);) {
    ...
    public boolean updateTodo(Todo todo) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = dbConnector.getConnection(); PreparedStatement statement = connection.prepareStatement(UPDATE_TODO);) {
